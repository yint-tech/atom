...
class SimpleHttpInvoker {
    ...
    companion object {
        ...
        private val threadLocalDefaultHttpProperty = ThreadLocal<DefaultHttpPropertyBuilder>()
        ...
        fun setupDefaultHttpProperty(defaultHttpPropertyBuilder: DefaultHttpPropertyBuilder?) {
