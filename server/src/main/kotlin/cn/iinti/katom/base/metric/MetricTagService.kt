package cn.iinti.katom.base.metric
...
import cn.iinti.katom.base.BroadcastService.Companion.register
import cn.iinti.katom.base.metric.MetricEnums.TimeSubType
import cn.iinti.katom.utils.Md5Utils.md5Hex
import cn.iinti.katom.utils.ServerIdentifier.id
...
class MetricTagService {
    ...
    @Resource
    private lateinit var metricTagMapper: MetricTagMapper
    ...
    private fun createTag(key: String, tags: List<Tag>): MetricTag {
        ...
        metricTag.name = key
        tags.sortedBy { it.key }.forEachIndexed { index, tag ->
            val tagName = tags[index].key
            when (index) {
