...
object Md5Utils {
    ...
    fun seedLong(key: String): Long {
        ...
        return (
                (digest[0].toInt() and 0xFF).toLong() shl 56 or
                        ((digest[1].toInt() and 0xFF).toLong() shl 48) or
                        ((digest[2].toInt() and 0xFF).toLong() shl 40) or
                        ((digest[3].toInt() and 0xFF).toLong() shl 32) or
                        ((digest[4].toInt() and 0xFF).toLong() shl 24) or
                        ((digest[5].toInt() and 0xFF).toLong() shl 16) or
                        ((digest[6].toInt() and 0xFF).toLong() shl 8) or
                        ((digest[7].toInt() and 0xFF).toLong())
                )
    }
