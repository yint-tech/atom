...
public class CodeGenerator {
    public static void main(String[] args) throws Exception {
        ...
        gc.setOutputDir(projectPath + "/atom-service/src/main/java");
        gc.setAuthor(System.getProperty("user.name"));
        gc.setOpen(false);
        mpg.setGlobalConfig(gc);

        File appConfigFile = new File(projectPath, "atom-service/src/main/resources-env/dev/application.properties");
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                return projectPath + "/atom-service/src/main/resources/mapper/" + pc.getModuleName()
