...
const useStyles = createUseStyles({
  ...
  active: {
    ...
    backgroundImage: ({ theme }) =>
      `repeating-linear-gradient(-45deg, ${theme.palette.background.paper}, ${theme.palette.background.paper} 25px, ${theme.palette.divider} 25px, ${theme.palette.divider} 50px)`,
  ...
  invalid: {
    // eslint-disable-next-line max-len
    backgroundImage: ({ theme }) =>
      `repeating-linear-gradient(-45deg, ${theme.palette.error.light}, ${theme.palette.error.light} 25px, ${theme.palette.error.dark} 25px, ${theme.palette.error.dark} 50px)`,
  ...
  return (
    <>
      ...
      (Array.isArray(showAlerts) &&
        showAlerts.includes(state.snackbarVariant)) ? (
        <Snackbar
