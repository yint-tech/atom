...
/**
 * 接口注册表，value 格式为 "url [post|form] [query]"：
 *   post  -> 以 JSON body 发起 POST
 *   post query -> 以 form-urlencoded 发起 POST
 *   form  -> 以 multipart/form-data 发起 POST
 *   默认  -> GET（query 标记时参数拼在路径上）
 */
