...
const SignIn = (props: RouteComponentProps) => {
  ...
  const [formState, setFormState] = useState<{
    isValid: boolean;
    values: { oa: string; password: string; policy: boolean };
    touched: Record<string, boolean>;
    errors: Record<string, string[]>;
  }>({
    isValid: false,
    values: {} as { oa: string; password: string; policy: boolean },
    touched: {},
    errors: {},
  });
...
// ValidationMap<RouteComponentProps> 结构不兼容，这里以类型断言桥接（纯类型层面）。
export default withRouter(SignIn as unknown as ComponentType<RouteComponentProps>);
